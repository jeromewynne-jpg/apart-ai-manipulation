...
\textbf{Study 2 (AI as instrument, human participants):} Does operator-favoring AI behavior affect real users? We ran a controlled experiment (n = 80 human participants) where human participants shopped with either a helpful or operator-aligned (upselling) AI assistant.

\textbf{Study 3 (AI as target, automated):} Do models resist user manipulation attempts? We tested 12 models across 153 scenarios where simulated users attempt to manipulate AI through emotional appeals, false urgency, deception, and other psychological tactics. An AI judge scored model responses, validated against 45 human raters (r = 0.83).
